...
def obtener_valor_numerico(text, keyword):
    ...
    if start_index != -1:
        ...
        # Buscar el primer número en el substring
...
prima_key = ["OP GRAVADA","OP. GRAVADA", "OP.GRAVADAS", "PRIMA TOTAL", "PRIMA COMERCIAL", "Op. Gravadas:"]
igv_key = ["IGV", "IMPSTO.GRAL. A VENTAS", "IGV", "IMPUESTO GENERAL A LAS VENTAS","I.G.V."]
